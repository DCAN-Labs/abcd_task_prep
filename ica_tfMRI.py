...
for subject in sys.argv[2:]:
    ...
    # Process SST
    sst1Folder = studyFolder + '/' + subject + '/MNINonLinear/Results/ica_tfMRI_SST1'
    sst2Folder = studyFolder + '/' + subject + '/MNINonLinear/Results/ica_tfMRI_SST2'
    ...
    if good:
        try:
            ...
            if scanner == 'Siemens':
                shutil.copy(FEATfolder+'/siemens/ica_tfMRI_SST1_hp200_s4_level1.fsf', sst1Folder)
                shutil.copy(FEATfolder+'/siemens/ica_tfMRI_SST2_hp200_s4_level1.fsf', sst2Folder)
            else:
                shutil.copy(FEATfolder+'/GE/ica_tfMRI_SST1_hp200_s4_level1.fsf', sst1Folder)
                shutil.copy(FEATfolder+'/GE/ica_tfMRI_SST2_hp200_s4_level1.fsf', sst2Folder)
            ...
            for run in {1,2}:
                for event in sstEV:
                    ...
                    fsf = studyFolder + '/' + subject + '/MNINonLinear/Results/ica_tfMRI_SST{0}/ica_tfMRI_SST{0}_hp200_s4_level1.fsf'.format(run)
                    checkEV(EVfile, fsf, sstEV[event], verbose=verbose)

            # Create folder for second level analysis and copy the template model file
            if os.path.exists(studyFolder + '/' + subject + '/MNINonLinear/Results/ica_tfMRI_SST')==False:
                os.makedirs(studyFolder + '/' + subject + '/MNINonLinear/Results/ica_tfMRI_SST')
            shutil.copy(FEATfolder+'/ica_tfMRI_SST_hp200_s4_level2.fsf', studyFolder + '/' + subject + '/MNINonLinear/Results/ica_tfMRI_SST')
            nGoodSST += 1
    ...
    # Process MID
    mid1Folder = studyFolder + '/' + subject + '/MNINonLinear/Results/ica_tfMRI_MID1'
    mid2Folder = studyFolder + '/' + subject + '/MNINonLinear/Results/ica_tfMRI_MID2'
    ...
    if good:
        try:
            ...
            if scanner == 'Siemens':
                shutil.copy(FEATfolder+'/siemens/ica_tfMRI_MID1_hp200_s4_level1.fsf', mid1Folder)
                shutil.copy(FEATfolder+'/siemens/ica_tfMRI_MID2_hp200_s4_level1.fsf', mid2Folder)
            else:
                shutil.copy(FEATfolder+'/GE/ica_tfMRI_MID1_hp200_s4_level1.fsf', mid1Folder)
                shutil.copy(FEATfolder+'/GE/ica_tfMRI_MID2_hp200_s4_level1.fsf', mid2Folder)


            # Create folder for second level analysis and copy the template model file
            if os.path.exists(studyFolder + '/' + subject + '/MNINonLinear/Results/ica_tfMRI_MID')==False:
                os.makedirs(studyFolder + '/' + subject + '/MNINonLinear/Results/ica_tfMRI_MID')
            shutil.copy(FEATfolder+'/ica_tfMRI_MID_hp200_s4_level2.fsf', studyFolder + '/' + subject + '/MNINonLinear/Results/ica_tfMRI_MID')
    ...
    # Process nBack
    nBack1Folder = studyFolder + '/' + subject + '/MNINonLinear/Results/ica_tfMRI_nBack1'
    nBack2Folder = studyFolder + '/' + subject + '/MNINonLinear/Results/ica_tfMRI_nBack2'
    ...
    if good:
        try:
            ...
            # Copy template model file
            if scanner == 'Siemens':
                shutil.copy(FEATfolder+'/siemens/ica_tfMRI_nBack1_hp200_s4_level1.fsf', nBack1Folder)
                shutil.copy(FEATfolder+'/siemens/ica_tfMRI_nBack2_hp200_s4_level1.fsf', nBack2Folder)
            else:
                shutil.copy(FEATfolder+'/GE/ica_tfMRI_nBack1_hp200_s4_level1.fsf', nBack1Folder)
                shutil.copy(FEATfolder+'/GE/ica_tfMRI_nBack2_hp200_s4_level1.fsf', nBack2Folder)



            # Create folder for second level analysis and copy the template model file
            if os.path.exists(studyFolder + '/' + subject + '/MNINonLinear/Results/ica_tfMRI_nBack')==False:
                os.makedirs(studyFolder + '/' + subject + '/MNINonLinear/Results/ica_tfMRI_nBack')
            shutil.copy(FEATfolder+'/ica_tfMRI_nBack_hp200_s4_level2.fsf', studyFolder + '/' + subject + '/MNINonLinear/Results/ica_tfMRI_nBack')
